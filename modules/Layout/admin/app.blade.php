            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} All rights reserved by  <a href="{{__('https://paktourismhub.furch35.com/')}}" target="_blank">Pakistan Tourism Hub</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://paktourismhub.furch35.com/page/privacy-policy')}}" target="_blank">Privacy Policy</a>
                            <a href="{{__('https://paktourismhub.furch35.com/contact')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
